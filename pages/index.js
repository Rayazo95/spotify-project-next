...
function Home(){
  ...
  <main className="main container">
    <div className="topbar">
      ...
      <div className="buttons-user">
        ...
        <a href="#" className="btn-login btn-full">
          Iniciar sesión
        </a>
      </div>
    </div>
    ...
    <section className="main-content">
      ...
      <div className="container-name-spotify-playlists">
        ...
        <div className="container-card-spotify-playlists">
          <div className="card-spotify-playlists">
            <div className="card">
              <div className="card-img">
                <img src="img/spotify playlists/top hits.jpg" alt="" />
              </div>
              <h2>Top hits 2000-2023</h2>
              <p>Top hits of 2000 to 2023</p>
            </div>
          </div>
          <div className="card-spotify-playlists">
            <div className="card">
          ...
          <div className="card-spotify-playlists">
            <div className="card">
              <div className="card-img">
                <img src="img/spotify playlists/neffex.jpg" alt="Neffex" />
              </div>
              <h2>Best of Neffex</h2>
              <p>The biggest songs of Neffex</p>
            </div>
          </div>
          <div className="card-spotify-playlists">
            <div className="card">
          ...
          <div className="card-spotify-playlists">
            <div className="card">
              <div className="card-img">
                <img
                  src="img/spotify playlists/dragonforce.jpg"
                  alt="DragonForce"
                />
              </div>
              <h2>Best of DragonForce</h2>
              <p>By bloogendorf</p>
            </div>
          </div>
          <div className="card-spotify-playlists">
      ...
      <div className="container-name-spotify-playlists">
        <h1 className="title-playlist">Recently Played</h1>
        <div className="container-card-spotify-playlists">
          <div className="card-spotify-playlists">
            <div className="card">
              <div className="card-img">
    ...
    <footer className="footer">
      <div className="container-links-footer">
        ...
        <div className="social-icons">
          <div className="container-icon" title="Instagram">
            <i className="fa-brands fa-instagram" />
          </div>
          <div className="container-icon" title="Facebook">
            <i className="fa-brands fa-facebook" />
          </div>
          <div className="container-icon" title="Twitter">
  ...
  <Script
			src="https://kit.fontawesome.com/02a2a62909.js"crossorigin="anonymous"></Script>
